	...
	switch(global.cameraStruct.type)
	{
		...
		case "extraSoftFollow":
		{
			if(global.cameraStruct.obj != noone)
			{
				...
				if global.cameraStruct.fixedX == noone and { _x = (global.cameraStruct.lastX + _cursorX) * 0.5; }
				if global.cameraStruct.fixedY == noone and { _y = (global.cameraStruct.lastY + _cursorY) * 0.5; }
